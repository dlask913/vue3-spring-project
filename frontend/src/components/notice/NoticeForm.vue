    ...
    <form @submit.prevent="onSaveNotice" >
        <div class="container mt-5" style="width: 40%;">
            ...
            <div class="mb-4">
                ...
                <input type="text" v-model="form.title" class="form-control" placeholder="제목을 입력하세요" required>
            </div>
            <div class="mb-4">
                <label for="content" class="form-label">내용</label>
                <textarea v-model="form.content" class="form-control" rows="10" placeholder="내용을 입력하세요" required></textarea>
            </div>
